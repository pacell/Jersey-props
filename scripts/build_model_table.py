...
"""Render the open-weights model index as a single self-contained HTML page.
    ...
    python3 scripts/build_model_table.py [-o site/open_models.html]
...
DEFAULT_OUT = os.path.join(ROOT, "site", "open_models.html")
...
def main() -> int:
    ...
    with open(os.path.join(ROOT, config.INDEX_JSON), encoding="utf-8") as fh:
